                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('projects.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="authors" id="authors" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('authors') border-red-500 @enderror" value="{{ old('authors') }}" required>
