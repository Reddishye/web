...
<body class="antialiased transition duration-200 text-zinc-900 dark:text-zinc-100 bg-zinc-100 dark:bg-black">
    @if (Route::has('login'))
    ...
    <div class="relative flex justify-center min-h-screen py-4 items-top sm:items-center sm:pt-0">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="z-0 flex justify-center mt-8 sm:justify-start sm:mt-0">
                <h1 class="z-0 mt-10 mb-8 ml-4 text-6xl font-extrabold text-center text-black dark:text-white" style="font-family: 'gg sans', 'Noto Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;">Hugo Torres</h1>
            </div>

            <div class="mt-8 overflow-hidden bg-white shadow dark:bg-black dark:border dark:border-black sm:rounded-lg">
                    ...
                    <div class="p-6 group">
                        <div class="flex items-center">
                            <div class="text-lg font-semibold leading-7">
                                ...
                                <span class="transition duration-200 text-zinc-900 dark:text-white group-hover:text-green-500 dark:group-hover:text-green-400">Technologies</span>
                            </div>
                        </div>

                        <div class="flex flex-col items-start mt-2 ml-6 text-sm transition duration-200 text-zinc-600 group-hover:text-zinc-700 dark:text-zinc-400 dark:group-hover:text-zinc-300">
                            <div class="grid justify-center grid-cols-4 gap-3">
                                <span @popper(Laravel) class="inline-flex items-center justify-center w-16 h-16 p-2 m-2 transition duration-200 ease-in-out transform rounded-full bg-zinc-200 hover:-translate-y-1 hover:scale-110 hover:bg-purple-500 hover:shadow-lg hover:shadow-purple-500/50 dark:bg-zinc-950 dark:hover:bg-purple-400 dark:hover:shadow-purple-400/50">
                                ...
                                <span @popper(TypeScript) class="inline-flex items-center justify-center w-16 h-16 p-2 m-2 transition duration-200 ease-in-out transform rounded-full bg-zinc-200 hover:-translate-y-1 hover:scale-110 hover:bg-purple-500 hover:shadow-lg hover:shadow-purple-500/50 dark:bg-zinc-950 dark:hover:bg-purple-400 dark:hover:shadow-purple-400/50">
                                    <x-devicon-typescript class="w-8 h-8 transition ease-in-out rounded-md duration-400 hover:text-white"/>
                                </span>
                ...
                <div class="p-6 mt-12 border-t border-zinc-200 dark:border-zinc-900 group">
                    <div class="flex items-center">
                        <div class="text-lg font-semibold leading-7">
                            <i class="mr-2 text-yellow-500 transition duration-200 fas fa-tasks group-hover:text-yellow-400"></i>
                            <span class="transition duration-200 text-zinc-900 dark:text-white group-hover:text-yellow-500 dark:group-hover:text-yellow-400">Projects</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-2 ml-6 text-sm transition duration-200 text-zinc-600 group-hover:text-zinc-700 dark:text-zinc-400 dark:group-hover:text-zinc-300">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                            @foreach ($projects as $project)
                                <div class="p-4 transition duration-200 ease-in-out transform rounded-lg shadow-md bg-zinc-200 dark:bg-zinc-950 hover:shadow-lg hover:scale-105">
                                    <h3 class="text-lg font-semibold text-zinc-900 dark:text-white">{{ $project->name }} <span class="inline-flex px-2 ml-2 text-xs font-semibold leading-5 transition duration-200 ease-in-out transform border-2 rounded-md select-none text-zinc-600 bg-zinc-200 border-zinc-300 hover:border-indigo-400 hover:text-indigo-500 hover:shadow-lg dark:bg-zinc-900 dark:border-zinc-800 dark:text-zinc-400 dark:hover:border-indigo-300 dark:hover:text-indigo-400">{{ $project->version }}</span></h3>
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold absolute top-0 right-0 mt-2 mr-2 rounded-full bg-zinc-200 border-dashed border-2 select-none @if ($project->status === 'active') border-green-300 @elseif ($project->status === 'inactive') border-red-300 @elseif ($project->status === 'archived') border-yellow-400 @elseif ($project->status === 'soon') border-orange-400 @endif dark:bg-zinc-900">@if ($project->status === 'active') ⭐ Active @elseif ($project->status === 'inactive') 💀 Inactive @elseif ($project->status === 'archived') 📦 Archived @elseif ($project->status === 'soon') 👀 Soon @endif</span>
            ...
            <div class="flex flex-col justify-center mt-4 sm:flex-row sm:justify-between sm:items-center">
                <div class="mb-4 text-sm text-center text-zinc-500 sm:text-left dark:text-zinc-400 sm:mb-0">
                ...
                <div class="mb-4 text-sm text-center text-gray-400 sm:mb-0">
                    <a href="{{ route('links.user') }}">
                        <div class="flex items-center justify-center sm:justify-center">
                            <i class="mx-1 mr-2 text-blue-500 fas fa-link"></i>
                ...
                <div class="text-sm text-center text-gray-400 sm:text-right">
                    <a href="mailto:contact@redactado.es">
                        <div class="flex items-center justify-center sm:justify-end">
                            <i class="mx-1 mr-2 text-green-500 fas fa-at"></i>
